...
export const MainComponent = () => {
  ...
  return (
    <div>
      <h2 className='fw-bold fs-2'>Weather Application</h2>
      <table id='customers'>
        <thead>
          <tr>
            <th className='head-container'>
              <button className='btn-style' onClick={() => handleNumberSortAsc('id')}>
                <ArrowUp
                  className='bg-light p-1 fs-3 rounded mx-1'
                  style={{ marginRight: '2%' }}
                  size={25}
                  color='black'
                />
