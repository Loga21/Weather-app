...
const Modal = () => {
  ...
  return (
    <div className='modal fade' id='staticBackdrop' aria-hidden='false'>
      <div
        className='modal-dialog modal-xl mt-5 modal-div rounded-5'
          ...
          <div className='my-5'>
            <div className='d-flex ms-5'>
              <div>
                ...
                <span className='h5 ms-2 text-muted'>{modalContent.country}</span>{' '}
              </div>
              {/* <div className=' fw-bold ms-2 align'>{modalContent.country}</div> */}
            </div>
            <div className='d-flex mt-3'>
              <div className='col-md-6 ms-1 position-relative'>
                <img
                  src={
                  ...
                  className='col-md-11 rounded-circle px-4 mt-2'
                  // alt={}
                  height={220}
                />
                <span
